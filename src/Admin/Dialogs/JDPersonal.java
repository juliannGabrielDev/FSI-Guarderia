...
public class JDPersonal extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JDPersonal.class.getName());

    /**
     * Creates new form JDAlumnos
     */
    public JDPersonal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        CBTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "educador", "admin" }));
